...
{
private:
    std::string PIN_main, pin_change_array[10], password_change_array[10], PASSWORD_main, NAME[10];
public:
    void check_CREDENTIALS()
    {
        ...
        do
        {
            ...
            check_for_empty_input(NAME[2]);
            std::cout << "\n\n\tEnter your pin: " << std::endl;
            std::getline(std::cin, pin_change_array[2]);
            check_for_empty_input(pin_change_array[2]);
            std::cout << "\n\n\tEnter your password: " << std::endl;
            std::getline(std::cin, password_change_array[2]);
            check_for_empty_input(password_change_array[2]);
            std::cout << "\n\n\tPLEASE WAIT WHILE CREDENTIALS ARE BEING VERIFIED!" << std::endl;
            if (NAME[2] != NAME[1] || password_change_array[2] != password_change_array[1] || pin_change_array[2] != pin_change_array[1])
            {
                clear_screen();
        ...
        } while (NAME[2] != NAME[1] || password_change_array[2] != password_change_array[1] || pin_change_array[2] != pin_change_array[1]);
        clear_screen();
    ...
    void take_CREDENTIALS()
    {
        ...
        pin = std::stoi(pin_change_array[1]);
        std::cout << "\n\n\tEnter Your Password: " << std::endl;
